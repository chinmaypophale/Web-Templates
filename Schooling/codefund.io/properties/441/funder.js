(function() {
  function embed () {
    ...
    function trackUplift() {
      try {
        var url = 'https://codefund.io/impressions/168b65fc-a67d-4302-b7e8-84f8c5eb532e/uplift?advertiser_id=239';
    ...
    try {
      ...
      codeFundElement.innerHTML = '<div id="cf" style="font-family: Helvetica, Arial; font-size: 13px;"> <span class="cf-wrapper" style="box-sizing: border-box; position: fixed; bottom: 0; z-index: 5000; width: 100%; border-top-width: 1px; border-top-color: #bfbfbf; border-top-style: solid; background-color: #eeeeee; text-align: center; line-height: 1.5; padding: 0.8em 1em 1em;"> <a data-href="campaign_url" class="cf-text" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; color: inherit; text-decoration: none;"> <strong>Segment</strong> <span>Send data to any tool without having to implement a new API every time.</span> </a> <a href="https://codefund.app" data-target="powered_by_url" class="cf-powered-by" target="_blank" rel="nofollow noopener" style="box-shadow: none !important; font-size: 12px; text-decoration: none; color: #999;"> <em>ethical</em> ad by CodeFund <img data-src="impression_url"> </a> </span> </div> <style>#cf .cf-text:before { margin-right: 4px; padding: 2px 6px; border-radius: 3px; background-color: #4caf50; color: #fff; content: \'Supporter\'; } #cf .cf-powered-by::before { content: \' \'; color: rgba(0, 0, 0, 0.3); display: inline-block; } </style>';
      codeFundElement.querySelector('img[data-src="impression_url"]').src = 'https://codefund.io/display/168b65fc-a67d-4302-b7e8-84f8c5eb532e.gif';
      codeFundElement.querySelectorAll('a[data-href="campaign_url"]').forEach(function (a) { a.href = 'https://codefund.io/impressions/168b65fc-a67d-4302-b7e8-84f8c5eb532e/click?campaign_id=411&creative_id=300&property_id=441&template=bottom-bar&theme=light'; });
